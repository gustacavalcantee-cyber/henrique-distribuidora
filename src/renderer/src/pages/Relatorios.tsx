...
import type { Rede, Loja, Franqueado, QuinzenaSummary, FinanceiroSummary, CobrancaLojaResult, NotaPagamento } from '../../../shared/types'
...
type RelatTab = 'quinzena' | 'financeiro' | 'cobranca'
    ...
    <div className="flex flex-col gap-4 h-full">
      ...
      <div className="border-b border-gray-200">
        <nav className="flex gap-0">
          {([['quinzena', 'Quinzena'], ['financeiro', 'Financeiro'], ['cobranca', 'Cobrança']] as [RelatTab, string][]).map(([id, label]) => (
      ...
      <div className="flex-1 overflow-auto">
        {activeTab === 'quinzena' ? <QuinzenaTab /> : activeTab === 'financeiro' ? <FinanceiroTab /> : <CobrancaTab />}
      </div>
    </div>
  )
}
