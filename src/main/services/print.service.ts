...
body { font-family: Arial, sans-serif; font-size: 10pt; background: #fff; width: 148mm; height: 190mm; }
.via { width: 148mm; height: 190mm; display: flex; flex-direction: column; font-size: 9.5pt; padding: 6mm 7mm; box-sizing: border-box; }
