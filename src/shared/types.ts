...
export interface NotaPagamento { pedido_id: number; loja_id: number; loja_nome: string; rede_nome: string; data_pedido: string; numero_oc: string; total_venda: number; status_pagamento: string }
